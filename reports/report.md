...
##### Security Headers
- **Score:** 14%
- **Missing Headers:** content-security-policy, strict-transport-security, x-content-type-options, x-frame-options, x-xss-protection, referrer-policy
...
##### Google Services
- **Google Analytics:** ✅ Detected (gtag.js)
- **Tag Manager:** ✅ GTM-W58S7SL
